...
c_rate_vec = [data_now.results_f.c_rate];

idx = find(c_rate_vec == C_rate ); % use index to find c_rate

SOC_now = data_now.results_f(idx).SOC_vec;
V_now = data_now.results_f(idx).V_vec;
%% Run initial model
